...
class Inventoriescreen extends StatefulWidget {
  const Inventoriescreen({super.key});

  @override
  State<Inventoriescreen> createState() => _InventoriescreenState();
}

class _InventoriescreenState extends State<Inventoriescreen> {
